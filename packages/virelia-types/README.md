...
Platform-agnostic base types for Virelia packages.
...
```ts
import type { BaseCheckboxProps } from '@romanbakurov/virelia-types';
...
```bash
pnpm --filter @romanbakurov/virelia-types build
```
